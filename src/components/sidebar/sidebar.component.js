        ...
        return (
            <nav className="sidebar">
                <ul className="sidebar-nav">
                    ...
                    <Link to="/category/motherboard" className="side-item">
                    ...
                    <Link to="/category/cpu" className="side-item">
                        <i className="uil uil-processor"></i>
                        <span className="link-text">CPU</span>
                    </Link>

                    <Link to="/category/storage" className="side-item">
                        <i className="fas fa-hdd"></i>
                        <span className="link-text">Storage</span>
                    </Link>

                    <Link to="/category/psu" className="side-item">
                        <i className="fas fa-plug"></i>
                        <span className="link-text">Power Unit / Cooling</span>
                    </Link>

                    <Link to="/category/ram" className="side-item">
                        <i className="fas fa-memory"></i>
                        <span className="link-text">Memory</span>
                    </Link>

                    <Link to="/category/monitor" className="side-item">
                        <i className="fas fa-tv"></i>
                        <span className="link-text">Monitors</span>
                    </Link>

                    <Link to="/category/peri" className="side-item">
                        <i className="fas fa-keyboard"></i>
                        <span className="link-text">Peripherals</span>
                    </Link>

                    <Link to="/category/graphics" className="side-item">
                    ...
                    <Link to="/category/cabinets" className="side-item">

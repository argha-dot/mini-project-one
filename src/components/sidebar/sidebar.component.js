    ...
    return (
        <nav className="sidebar">
            ...
            <ul className="sidebar-nav">
                ...
                <Link to={{state: {user: user}, pathname:"/category/motherboard"}} className="side-item">
                ...
                <Link to={{state: {user: user}, pathname: "/category/cpu"}} className="side-item">
                    <i className="uil uil-processor"></i>
                    <span className="link-text">CPU</span>
                </Link>

                <Link to={{state: {user: user}, pathname: "/category/storage"}} className="side-item">
                    <i className="fas fa-hdd"></i>
                    <span className="link-text">Storage</span>
                </Link>

                <Link to={{state: {user: user}, pathname: "/category/psu"}} className="side-item">
                    <i className="fas fa-plug"></i>
                    <span className="link-text">Power Unit / Cooling</span>
                </Link>

                <Link to={{state: {user: user}, pathname: "/category/ram"}} className="side-item">
                    <i className="fas fa-memory"></i>
                    <span className="link-text">Memory</span>
                </Link>

                <Link to={{state: {user: user}, pathname: "/category/monitor"}} className="side-item">
                    <i className="fas fa-tv"></i>
                    <span className="link-text">Monitors</span>
                </Link>

                <Link to={{state: {user: user}, pathname: "/category/peri"}} className="side-item">
                    <i className="fas fa-keyboard"></i>
                    <span className="link-text">Peripherals</span>
                </Link>

                <Link to={{state: {user: user}, pathname: "/category/graphics"}} className="side-item">
                ...
                <Link to={{state: {user: user}, pathname: "/category/games"}} className="side-item">
                    <i className="fas fa-gamepad"></i>
                    <span className="link-text">For Gamers</span>
                </Link>

                <Link to={{state: {user: user}, pathname: "/category/cabinets"}} className="side-item">
